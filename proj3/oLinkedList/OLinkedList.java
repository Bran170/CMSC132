    ...
    implements Comparable<OLinkedList<T>> 
{
    ...
    public OLinkedList(OLinkedList<T> otherOLinkedList) 
    {
        ...
        {
            head = new Node<T>(otherOLinkedList.head.value);
    ...
    // value of firstElt and ending with the first Node with an Object value 
    ...
    public OLinkedList<T> subList(T firstElt, T lastElt) 
    {
        ...
        while (current != null)
        {
            ...
            if (current.value.compareTo(lastElt) == 0 && last == null && 
                    first!= null)
            {
                last = current; 
            }
